...
urlpatterns = [
    ...
    url(r'^groups/(?P<gid>\d+)/delete/$', \
           login_required(GroupDeleteView), \
                  name='groups_delete'),
    ...
    url(r'^exam/(?P<pk>\d+)/edit_exam/$', \
           login_required(exam_edit.as_view()), \
                  name='exam_edit'),
    url(r'^exam/(?P<pk>\d+)/delete_exam/$', \
           login_required(exam_delete.as_view()), \
                  name='exam_delete'),
    url(r'^exam/add/$', login_required(add_exam.as_view()), \
                  name='add_exam'),
    ...
    url(r'^django-contact-admin/$', \
           CustomContactFormView.as_view(), \
                  name='django-contact-admin'),
